...
hi zone_color ctermfg=LightYellow guifg=#f4e360 gui=none
hi calzones_else ctermfg=Blue ctermbg=Blue guifg=Green guibg=Blue
hi calzones_if ctermfg=Green ctermbg=Green guifg=Green guibg=Blue
sign define calzones_if text=| texthl=zone_color
sign define calzones_else text=| texthl=zone_color
